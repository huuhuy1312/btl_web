    ...
    <body>
        <div class="container">
            <div class="table-wrapper">
                ...
                <div class="clearfix">
                    <div class="hint-text">Showing <b>3</b> out of <b>${totalNumPro}</b> entries</div>
                    <ul class="pagination">
                    	<c:forEach begin="1" end="${totalPage}" var="n">
                        	<li class="page-item disabled"><a href="managerProduct?index=${n}">${n}</a></li>
                        </c:forEach>
                    </ul>
                </div>
            ...
            <button class="btn btn-default btn-returnMenu"><a class= "returnHome" href="home">Home</a></button>
